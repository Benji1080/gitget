## ⚡ میرور کردن فایل‌ها از اینترنت در رپو

اگر میخواید یک فایل از اینترنت میرور کنید، کافیه لینکش رو به این اکشن بدید تا بذاره داخل رپوی مورد نظرتون.
...
نکته: اگر حجم فایل بیشتر از 100 مگابایت باشه، اون رو به پارت های زیپ شده تقسیم میکنه که بعد از دانلود باید اکسترکت کنید.
